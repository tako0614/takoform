...
| `specification-1.1-publication-evidence.json` | `0bda938c669e5facecf3def59d951b4469620564` | `6f2ba3d51261f2559d0738ed2b22f51d7066d4d5b9f9bf0213694f352b677a84` | exact Specification 1.1 release asset source; its embedded predecessor paths remain historical facts |
...
The imported Specification receipt deliberately keeps the original asset
`sourcePath` (`spec/publication-evidence.json`). That field records where the
predecessor release built the asset; it is not rewritten to this custody path.

Current Specification release truth remains in
[`release/specification-releases.json`](../../../release/specification-releases.json),
and current schema identities remain in
