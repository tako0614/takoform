...
// complete stable error envelopes, and an 8MiB response cap) while keeping its
// wire vocabulary independent of any product integration.
package hostclient
...
const (
	...
	defaultUserAgent     = "takoform-hostclient"
...
// delete that means a caller drops the resource from state while the host
// leaves it running.
//
