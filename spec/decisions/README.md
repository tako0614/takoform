...
- [0047 — The Host API is a substrate a Form declares against, and the two version apart](0047-the-host-api-is-the-substrate-a-form-declares-against.md)
- [0048 — The protocol states mechanisms; a family instantiates them](0048-the-protocol-states-mechanisms-not-forms.md)
- [0049 — A Form versions alone: the family group carries no version, and constraints leave the schema](0049-a-form-versions-alone.md)
- [0050 — A standard-backed Form provisions an instance; it never respecifies the protocol](0050-a-standard-backed-form-provisions-an-instance-not-a-protocol.md)
- [0051 — An unserved lane is withdrawn into its successor, not stacked beside it](0051-an-unserved-lane-is-withdrawn-not-stacked.md)
...
- [0059 — Core SemVer identifies the software artifact](0059-core-semver-identifies-the-software-artifact.md)
