...
[`interface-ref-v1alpha1.schema.json`](../schemas/interface-ref-v1alpha1.schema.json).

## Interface Definition

The normative Definition shape is
[`interface-definition-v1alpha1.schema.json`](../schemas/interface-definition-v1alpha1.schema.json).
