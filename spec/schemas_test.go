...
func TestNormativeSchemasMatchTheImplementation(t *testing.T) {
	implementations := map[string]string{
		...
		"form-ref-v1.schema.json":                           filepath.Join("..", "formpackage", "schemas", "form-ref-v1.schema.json"),
		...
		"form-package-revocation-v1.schema.json":            filepath.Join("..", "formpackage", "schemas", "form-package-revocation-v1.schema.json"),
		...
		"form-package-revocation-checkpoint-v1.schema.json": filepath.Join("..", "formpackage", "schemas", "form-package-revocation-checkpoint-v1.schema.json"),
	}
