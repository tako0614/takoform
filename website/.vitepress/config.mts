...
// scripts/site.mjs and checked byte-for-byte by `bun run check:site`. Editing
// them here creates a second copy of a normative document.
...
const specificationSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: "Normative schemas", link: "/spec/schemas/" },
    ],
  },
];
