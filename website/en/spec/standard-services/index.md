---
# Generated from spec/standard-services/README.md by scripts/site.mjs. Edit the specification, not this page.
normative: true
canonicalSource: spec/standard-services/README.md
canonicalUrl: https://github.com/tako0614/takoform/blob/main/spec/standard-services/README.md
---
...
- `service` validates against
  [`standard-service-ref-v1.schema.json`](https://forms.takoform.com/schemas/standards/v1/standard-service-ref.schema.json).
...
[`standard-service-ref-v1alpha1.schema.json`](https://forms.takoform.com/schemas/standards/v1alpha1/standard-service-ref.schema.json)
