---
# Generated from spec/project-lifecycle.md by scripts/site.mjs. Edit the specification, not this page.
canonicalSource: spec/project-lifecycle.md
canonicalUrl: https://github.com/tako0614/takoform/blob/main/spec/project-lifecycle.md
---
...
Exact compatibility rules are in [`versioning.md`](/spec/versioning), package and
artifact checks are in [`conformance.md`](/spec/conformance), and portable field
selection is in [`portability-boundary.md`](/spec/portability-boundary).
...
[`form-families.md`](/spec/form-families) for the namespace and role rules. A
...
[`portability-boundary.md`](/spec/portability-boundary). A first implementation or
...
`0.x` rules in [`versioning.md`](/spec/versioning).
...
or relabelled; [`versioning.md`](/spec/versioning) defines how retained identities
...
[`trust/`](https://github.com/tako0614/takoform/tree/main/trust). It may block new creation, update, or activation while
...
[`versioning.md`](/spec/versioning); this lifecycle record does not reinterpret
